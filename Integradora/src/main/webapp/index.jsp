...
<nav class="navbar navbar-expand-lg navbar-light blue fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <!--
              <li class="nav-item">
                  <span style="color: #009574;">a</span>
                  <a href="" class="btn btn-primary"><i class="fas fa-shopping-cart"></i>Mi Carrito(0)</a>
              </li>
             -->
        </ul>
    </div>
...
<div class="wrapper fixed-left">
    <nav id="sidebar" style="border-left: solid 4px #009574; border-right: solid 4px #009574; border-bottom: solid 4px #009574; border-top: #009574;">
        ...
        <ul class="list-unstyled components">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <i class="fas fa-user-friends"></i>Iniciar sesión
                </a>
            ...
            <li>
                <a href=""><i class="fas fa-dumpster-fire"></i>Lo más vendido</a>
            </li>
            <!--
                <li>
            ...
            -->
            <li>
                <a href=""><i class="fas fa-boxes"></i>Categorías</a>
            </li>
            <!--
            <li>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            ...
                            <button type="button" class="btn btn-success"><b>Ver más</b><i class="fas fa-plus"></i>
                            </button>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-footer">
                                    ...
                                    <div>
                                        ...
                                        <a href="" class="btn btn-primary"><i class="fas fa-cash-register"></i>Comprar Ahora</a>
                                    </div>
                                    </center>
                                </div>
                            </div>
    ...
    <article>
        ...
        <br>
        <br>
        <aside><h3>Promociones de hoy:</h3></aside>
        <hr>
